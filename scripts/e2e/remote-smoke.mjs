/**
 * Playwright smoke against production (roses.ursamu.io).
 *
 * Usage:
 *   node scripts/e2e/remote-smoke.mjs
 *   BASE_URL=https://roses.ursamu.io node scripts/e2e/remote-smoke.mjs
 *
...
const BASE = (process.env.BASE_URL || "https://roses.ursamu.io").replace(
  /\/$/,
  "",
);
